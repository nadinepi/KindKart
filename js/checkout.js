...
var parseCoupons = function(coupons, domain) {
    ...
    if (overall == "N/A"){
        ...
        couponDisplay.innerHTML = '<h1>KindKart</h1>'
        +'<div><p id="ethicalrating">Ethical Rating for <strong>'+brand+'</strong></p>'
        +'<div><p id="message" style="color: #EF4C4C"><br><br>This company does not have satisfactory ethics. :( Try to limit your spending here...</p></div>'
        +'<p id="ethics">'+str1+'</p></div>'
        +'<p> If not, below are some coupons for <strong>'+domain+'</strong>. After you save, pay it forward to a charity of your choice!</p>'
